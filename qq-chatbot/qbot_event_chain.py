...
class ChainNode:
    def __init__(self, conversation: Conversation, preaction=None, action=None, next_node=None):
    ...
    def chain(self, bot: Chatbot, *args, **kwargs):
        ...
        if self.next_node is None:
            res=bot.chat(self.conversation, mark_before_action=False)
        else:
            res=bot.chat(self.conversation, mark_before_action=False,
